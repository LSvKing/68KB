...
class Theme_model extends CI_Model {
	...
	{
		if (file_exists(ROOTPATH .'themes/front/'.$template.'/config.php'))
		{
			require_once(ROOTPATH .'themes/front/'.$template.'/config.php');
	...
	{
		$location = ROOTPATH.'themes/front/';
		$available_theme = '';
		$i=0;
